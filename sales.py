...
#--------------------------------------------------------------------------------
    def __init__(self,window):
        ...
        invoice_lbl=Label(self.window,text="Invoice No.",font=("times new romen",15),bg="black")
        ...
        search_btn=Button(self.window,text="Search",font=('Georgia',12),bg='green',fg="black",cursor="hand2",command=self.search)
        search_btn.place(x=360,y=100,width=120,height=28)

        clear_btn=Button(self.window,text="Clear/Refresh",font=('Georgia',12),bg="gray",fg="black",cursor="hand2",command=self.clear)
        ...
        self.img1=Image.open("/Users/sarvagyasinghs/Downloads/sales_logo.jpeg").resize((380,320))
