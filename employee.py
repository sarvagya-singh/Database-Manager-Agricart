...
class employeeClass:
    ...
    def Add(self):
        if self.var_emp_id.get()=='':
            ...
            try:
                con=pymysql.connect(host='localhost',user='root',password='Sarvagya2807')
                mycursor=con.cursor()
            except:
...
#------------------------------------------------------------------------------
    def __init__(self,window):
        ...
        searchframe=LabelFrame(self.window,text="Search Employee",font=("goudy old style",12,"bold"),bg='black')
        ...
        btn_search=Button(searchframe,text="Search",font=("goudy old style",12),bg="green",fg="black",command=self.search)
        btn_search.place(x=400,y=8,width=150,height=25)

        #title

        title=Label(self.window,text='Employee Details',font=('Georgia',15),bg='Gray14',fg='White')
        title.place(x=50,y=100,width=1000)

        #content
        #row1

        emp_id_lbl=Label(self.window,text='Emp Id :-',font=('Georgia',15),bg='Black')
        emp_id_lbl.place(x=50,y=150)

        contact_lbl=Label(self.window,text='Contact :-',font=('Georgia',15),bg='Black')
        ...
        name_lbl=Label(self.window,text='Name :-',font=('Georgia',15),bg='Black')
        name_lbl.place(x=50,y=190)  

        Email_lbl=Label(self.window,text='Email :-',font=('Georgia',15),bg='Black')
        ...
        password_lbl=Label(self.window,text='Password:-',font=('Georgia',15),bg='Black')
        password_lbl.place(x=48,y=230)

        user_type_lbl=Label(self.window,text='User Type :-',font=('Georgia',15),bg='Black')
        ...
        salary_lbl=Label(self.window,text='Salary :-',font=('Georgia',15),bg='Black')
        ...
        btn_Add=Button(self.window,text="Save",font=("goudy old style",12),bg="deep sky blue",fg="Black",command=self.Add)
        btn_Add.place(x=800,y=150,width=150,height=25)

        btn_Update=Button(self.window,text="Update",font=("goudy old style",12),bg="green",fg="Black",command=self.Update)
        btn_Update.place(x=800,y=190,width=150,height=25)

        btn_Delete=Button(self.window,text="Delete",font=("goudy old style",12),bg="red",fg="Black",command=self.delete)
        btn_Delete.place(x=800,y=230,width=150,height=25)

        btn_Clear=Button(self.window,text="Clear",font=("goudy old style",12),bg="gray",fg="Black",command=self.clear)
