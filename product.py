...
class productClass:
    ...
    def __init__(self,window):
        ...
        title=Label(product_frame,text='Product Details',font=('Georgia',18),bg='Gray14',fg='black')
        title.pack(side=TOP,fill=X)

        #label
        category_lbl=Label(product_frame,text='Category',font=('Georgia',18),bg='black')
        category_lbl.place(x=30,y=60)
        supplier_lbl=Label(product_frame,text='Supplier',font=('Georgia',18),bg='black')
        supplier_lbl.place(x=30,y=110)
        product_lbl=Label(product_frame,text='Name',font=('Georgia',18),bg='black')
        product_lbl.place(x=30,y=160)
        price_lbl=Label(product_frame,text='Price',font=('Georgia',18),bg='black')
        price_lbl.place(x=30,y=210)
        quantity_lbl=Label(product_frame,text='Quantity',font=('Georgia',18),bg='black')
        quantity_lbl.place(x=30,y=260)
        status_lbl=Label(product_frame,text='Status',font=('Georgia',18),bg='black')
        ...
        btn_Add=Button(product_frame,text="Save",font=("goudy old style",12),bg="deep sky blue",fg="black",command=self.Add)
        btn_Add.place(x=10,y=400,width=100,height=40)

        btn_Update=Button(product_frame,text="Update",font=("goudy old style",12),bg="green",fg="black",command=self.Update)
        btn_Update.place(x=120,y=400,width=100,height=40)

        btn_Delete=Button(product_frame,text="Delete",font=("goudy old style",12),bg="red",fg="black",command=self.delete)
        btn_Delete.place(x=230,y=400,width=100,height=40)

        btn_Clear=Button(product_frame,text="Clear",font=("goudy old style",12),bg="gray",fg="black",command=self.clear)
        btn_Clear.place(x=340,y=400,width=100,height=40)

        #search bar

        searchframe=LabelFrame(self.window,text="Search Product",font=("goudy old style",12,"bold"),bg='black')
