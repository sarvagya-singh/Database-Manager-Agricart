...
class dash:
    def __init__(self,window):
        ...
        #title
        logo=Image.open("/Users/sarvagyasinghs/Downloads/agricat_logo.jpeg").resize((80,70))
        self.photo=ImageTk.PhotoImage(logo)

        title=Label(self.window,text='Agricart: Grocery Management System',image=self.photo,compound=LEFT
                    ,font=('Georgia',30,'bold'),bg='DarkGoldenrod1',fg='black',anchor="w",padx=20)
        title.place(x=0,y=0,relwidth=1,height=70)

        #log out Button

        btn_logout=Button(self.window,text='Logout',font=('times new roman',15,'bold'),fg='Black',bg='black',
        ...
        self.lbl_clock=Label(self.window,text='Welcome To Agricart Management System \t\t Date:dd-mm-yyyy\t\t Time:hh:mm:ss',
        ...
        btn_seles=Button(LeftMenu,text='Sales',font=('Georgia',20),bg='White',fg='black',
    ...
    def update_content(self):
        ...
        try:
            ...
            self.lbl_clock.config(text=f'Welcome Agricart: Fruits and Vegetables Management System \t\t Date:{str(date1)}\t\t Time:{str(time1)}')
