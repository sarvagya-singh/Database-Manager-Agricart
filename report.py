...
class reportClass:
    ...
    def __init__(self,window):
        ...
        searchframe=LabelFrame(self.window,text="Search Bills",font=("goudy old style",12,"bold"),bg='black')
        searchframe.place(x=250,y=80,width=600,height=70)

        #option

        search_lbl=Label(searchframe,text="Search By Bill No.",font=('goudy old style',14),bg="black")
