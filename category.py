...
class categoryClass:
    ...
    def __init__(self,window):
        ...
        name_lbl=Label(self.window,text="Enter Category Name",font=('Georgia',20),bg='black')
        ...
        add_btn=Button(self.window,text="ADD",font=('Georgia',12),bg='green',fg="black",cursor="hand2",command=self.Add)
        add_btn.place(x=360,y=170,width=150,height=30)

        delete_btn=Button(self.window,text="DELETE",font=('Georgia',12),bg='red',fg="black",cursor="hand2",command=self.delete)
