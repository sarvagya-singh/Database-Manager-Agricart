...
#====================================================================================
    def __init__(self,window):
        ...
        title=Label(self.window,text=' Agricart: Fruits and Vegetable Management System',image=self.photo,compound=LEFT
        ...
        self.clock_label=Label(self.window,text='Welcome To Agricart Management System \t\t Date:dd-mm-yyyy\t\t Time:hh:mm:ss',
        ...
        product_title=Label(product_frame,text="All Products",font=('Georgia',20),bg='Gray14',fg='black')
        ...
        search_label=Label(product_frame2,text="Search Product(By Name)",font=("times newm roman",15,"bold"),bg="black",fg="green")
        search_label.place(x=2,y=5)

        name_label=Label(product_frame2,text="Product Name",font=("times newm roman",12,"bold"),bg="black")
