...
#------------------------------------------------------------------------------
    def __init__(self,window):
        ...
        searchframe=LabelFrame(self.window,text="Search Supplier",font=("goudy old style",12,"bold"),bg='black')
        searchframe.place(x=250,y=20,width=600,height=70)

        #option

        search_lbl=Label(searchframe,text="Search By Invoice No.",font=('goudy old style',14),bg="black")
        ...
        title=Label(self.window,text='Supplier Details',font=('Georgia',15),bg='Gray14',fg='black')
        title.place(x=50,y=100,width=1000)

        #content
        #row1

        emp_spplier_invoice=Label(self.window,text='Invoice No. :-',font=('Georgia',15),bg='black')
